                    ...
                    <form action="" method="POST">
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" name="ckb[]" value="<?php echo $r->orde_id ?>"/></td>
                                    <td>
                                        <?php
                                        $user = get_user_by_id($r->orde_userid);
                                    ...
                                    <td><?php if($r->orde_status==1){echo "<font color=green>Đã xử lý</font>";}else{echo "<font color=red>Chưa xử lý</font>";} ?></td>                             
                                </tr>
                                <?php }
                                // End For
                                } else {
                        ...
                        <input class="btn" type="submit" name="change" value="Đổi trạng thái" />
