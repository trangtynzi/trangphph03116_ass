                    ...
                    <div class="block-fluid">     
                        ...
                        <form action="" method="POST">
                            <div class="row-form">
                                ...
                                <div class="span3"><input type="text" required="" name="prod_name" /></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                            ...
                            <div class="row-form">
                                ...
                                <div class="span9"><textarea name="prod_description" class="ckeditor" id="ckeditor"></textarea></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Images :</div>
                                <div class="span6">
                                    <textarea id="xFilePath" name="prod_images"></textarea>
                            ...
                            <div class="row-form">
                                ...
                                <div class="span6"><input type="text" required="" name="prod_" /></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Product Features :</div>
                                <div class="span9"><textarea name="prod_features" class="ckeditor" id="ckeditor"></textarea></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Technical Specs :</div>
                                <div class="span9"><textarea name="prod_specs" class="ckeditor" id="ckeditor"></textarea></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                                <div class="span3">Delivery :</div>
                                <div class="span9"><textarea name="prod_delivery" class="ckeditor" id="ckeditor"></textarea></div>
                                <div class="clear"></div>
                            </div>
                            <div class="row-form">
                                <div class="span3"></div>
